...
public class carTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("현재 속도는 : " + konaSpeed);		
		...
		carnibal.pressEngineStartButton();
		carnibal.pressBrakePedak(10);
		carnibal.pressBrakePedak(10);
		
		//carnibal 엔진 상태 출력
		boolean carnibalEngineState = carnibal.isEngineStart;
		System.out.println("carnibal engine : " + carnibalEngineState);
		
		// carnibal 현재 속도 출력
		int carnibalSpeed = carnibal.speed;
		System.out.println("carnibal의 현재 속도는 : " + carnibalSpeed);
