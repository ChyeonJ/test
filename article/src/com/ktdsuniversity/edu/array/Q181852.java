 ...
 * 5. {4, 1, 15, 46, 38, 10, 14, 56, 32, 12};
 * 6. {1, 4, 15, 46, 38, 10, 14, 56, 32, 12};
 * 7. {1, 4, 14, 46, 38, 10, 15, 56, 32, 12};
 * 8. {1, 4, 10, 38, 14, 46, 15, 56, 32, 12};
 * 9. {1, 4, 10, 38, 14, 32, 15, 56, 46, 12};
 * 10. {1, 4, 10, 14, 38, 32, 15, 56, 46, 12};
 * 11. {1, 4, 10, 14, 32, 38, 15, 56, 46, 12};
 * 12. {1, 4, 10, 14, 32, 38, 15, 56, 46, 12};
 * ..............................................
 * 12. {1, 4, 10, 12, 14, 15, 32, 38, 46, 56};
 */
public class Q181852 {
	...
	public static void main(String[] args) {
		...
		//System.out.println(Arrays.toString(numList)); 	//[1, 4, 10, 12, 14, 15, 32, 38, 46, 56]
