...
public class Market {
	...
	public static void main(String[] args) {
		...
		//Consumer consumer = new Consumer(10, 10_000, 10_00);
		//SellerExam seller = new SellerExam(2);
		
		//seller.sellerTotal(3);
		...
		//seller sell 하기전에 재고 있는지, 구매자는 돈이 있는지 체크
